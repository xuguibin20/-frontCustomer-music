  ...
  <div class="main">
    <div class="nav1">
      <transition name="fade2" appear>
        <div class="nav1-left">
          <img src="@/assets/img/Login/footer.jpg" alt="" />
        </div>
      </transition>
    ...
    <div class="wrapper">
      <div class="content1">
        <h1 class="fade1">
          <span style="color: rgb(95, 138, 255)">音乐,</span>陪你做生活的演奏师
        </h1>
        ...
        <div class="footer fade1">
          <h3>
            <span style="color: rgb(95, 138, 255)">音乐,</span>
            探索更多，发现更多
          </h3>
